...
//     }
//
//     s = time.Date(s.Year(), s.Month(), s.Day(), 0, 0, 0, 0, t.Location())
//     return s, y, w
// }
...
func TruncateWeeks(t time.Time, n int) time.Time {
	...
	out := firstDayOfEpochWeek.Add(time.Duration(gap) * week)
	out = time.Date(out.Year(), out.Month(), out.Day(), 0, 0, 0, 0, t.Location())
	return out
}
