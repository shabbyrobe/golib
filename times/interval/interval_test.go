...
func TestCanCombine(t *testing.T) {
	for _, tc := range []struct {
		...
		{Days1, Weeks1, true},
		{Days2, Weeks1, false},
		{Days7, Raw(2, Week), false}, // No way to specify how these line up, so it makes sense that you can't convert.

		{Weeks1, Raw(1, Minute), false},
		{Weeks1, Hours1, false},
		{Weeks1, Days1, false},
		{Weeks1, Raw(14, Day), false},
		{Weeks1, Weeks1, false},
		{Weeks1, Raw(2, Week), true},
		{Weeks1, Months1, false},
		{Weeks1, Raw(1, Year), false},

		{Months1, Mins1, false},
		{Months1, Days1, false},
		{Months1, Weeks1, false},
		{Months1, Months1, false},
		{Months1, Raw(2, Month), true},
		{Months1, Raw(1, Year), true},
